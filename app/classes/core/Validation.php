    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = 'Parameter  '.$this->name.' Is Not Valid';
                }
        ...
        public function required(){
            ...
            if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
                $this->errors[] = 'Parameter '.$this->name.' Is Required.';
            }            
            return $this;
         ...
         * @return value
         */
        public function getValue($purify = false){
        ...
        /**
         * verify If the fiels is a correct 
         * Json
         *
         * @param mixed $value
         * @return this
        ...
        public function is_json($value = null){
            ...
            if(!(json_last_error() === JSON_ERROR_NONE))
                $this->errors[] = 'Field '.$this->name.' Is Not A Correct Json';
            return $this;
